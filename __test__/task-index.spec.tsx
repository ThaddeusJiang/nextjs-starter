...
import Tasks, { formatParmas, generateTabInfos, TAB_NAMES } from "../pages/tasks/index";
...
describe("Tasks page", () => {
  ...
  it("should trigger submit event", async () => {
    ...
    waitFor(() => {
      expect(formatParmas).toHaveBeenCalled();
    });
  });

  // test formatParmas function with all input
  it("should match the mockData", async () => {
    const mockFromData = {
      startAt: "2020-01-20",
      endAt: "2020-01-21",
      host: "dev1.wonderfulapp.com",
    };
    const result = formatParmas(mockFromData, {});
    expect(result.filter).toBeTruthy();
  });

  // test formatParmas function only with endAt
  ...
  // test formatParmas function only with startAt
  it("should only return 'scheduledStartedAt >'", async () => {
    const mockFromData = {
      startAt: "",
      endAt: "",
  ...
  // test formatParmas function only with empty
  it("should only return scheduledStartedAt <=", async () => {
    const mockFromData = {
      startAt: "",
      endAt: "",
